const styles = {
    ...
    btnBlack:
      "bg-black flex items-center py-4 px-8 rounded-md mt-2 w-fit cursor-pointer",
  
    section0: "flex justify-center items-center p-16 sm:p-8 -mt-5",
    section: "flex justify-center items-center p-16 sm:p-8",
    subSection: "flex items-center w-full minmd:w-3/4",
    descDiv: "flex-1 w-full flex justify-start flex-col",
    ...
    btnIcon: "w-7 h-7 minmd:w-15 minmd:h-15 object-contain",
